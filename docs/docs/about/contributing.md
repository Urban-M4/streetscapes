...
We welcome any kind of contribution to our software, from simple comment or question to a full fledged [pull request](https://help.github.com/articles/about-pull-requests/). Please read and follow our [Code of Conduct](https://github.com/Urban-M4/streetscapes/CODE_OF_CONDUCT.md).
...
1. Use the search functionality [here](https://github.com/Urban-M4/streetscapes/issues) to see if someone already filed the same issue;
...
1. Install dependencies (see the [development documentation](https://github.com/Urban-M4/streetscapes/README.md#-setup));
...
1. Check the author list in [`CITATION.cff`](https://github.com/Urban-M4/streetscapes/CITATION.cff)
1. Update the version number in setup.cfg and CITATION.cff
1. Update the `CHANGELOG.md` to include changes made
1. Go to the [GitHub release page](https://github.com/Urban-M4/streetscapes/releases)
